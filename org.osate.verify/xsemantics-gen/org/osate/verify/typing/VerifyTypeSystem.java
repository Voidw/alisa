...
public class VerifyTypeSystem extends CommonTypeSystem {
  ...
  protected void assignablesequenceThrowException(final String _error, final String _issue, final Exception _ex, final VerificationActivity owner, final List<FormalParameter> formalParams, final List<PropertyExpression> actuals, final ErrorInformation[] _errorInformations) throws RuleFailedException {
  ...
  protected Result<Boolean> assignablesequenceImpl(final RuleEnvironment G, final RuleApplicationTrace _trace_, final VerificationActivity owner, final List<FormalParameter> formals, final List<PropertyExpression> actuals) throws RuleFailedException {
    try {
    	final RuleApplicationTrace _subtrace_ = newTrace(_trace_);
  ...
  protected Result<Boolean> applyRuleAssignableSequence(final RuleEnvironment G, final RuleApplicationTrace _trace_, final VerificationActivity owner, final List<FormalParameter> formals, final List<PropertyExpression> actuals) throws RuleFailedException {
    ...
    for (final PropertyExpression actual : actuals) {
  ...
  protected Result<Boolean> applyRuleAssignable(final RuleEnvironment G, final RuleApplicationTrace _trace_, final VerificationActivity owner, final FormalParameter formal, final PropertyExpression actual) throws RuleFailedException {
